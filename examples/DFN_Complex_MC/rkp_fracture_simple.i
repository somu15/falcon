...
x_out = -65 # -2.05e+02 # -300.0 # (+ random value within a circle of 200 radius)
y_out = -122 # -1.32e+02 # 0.0 # (+ random value within a circle of 200 radius)
z_out = -574 # -3.49e+02 # -300.0 # (+ random value within a circle of 200 radius)

[Mesh]
  uniform_refine = 0
  [cluster34]
    type = FileMeshGenerator
    file = 'Model_29_5m_Base_Model_Zone_2_mesh.exo'
  []
[]
