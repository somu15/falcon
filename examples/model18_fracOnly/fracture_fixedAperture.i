...
[Mesh]
  ...
  [inputDFN]
    ...
    # file = 'Simple_Cubit.e'
    file = 'Model_18_5m_Base_Model_Zone_1_mesh.exo'
  []
  [injection_node]
    type = BoundingBoxNodeSetGenerator
    input = inputDFN
    bottom_left = '-275 138 -63'
    top_right = '-274 139 -62'
    new_boundary = injection_node
    #for the 5m mesh
    #Node       56216  -2.745783552E+02   1.383400352E+02  -6.240531095E+01
  []
[]
...
[DiracKernels]
  [inject_fluid]
    ...
    point = '-2.745783552E+02   1.383400352E+02  -6.240531095E+01'
    variable = frac_P
  []
  [withdraw_fluid]
    type = PorousFlowPeacemanBorehole
    SumQuantityUO = kg_out_uo
    bottom_p_or_t = 13.6 # 1MPa + approx insitu at production point (depth = 1000m+259m), to prevent aperture closing due to low porepressures
    character = 1
    line_length = 1
    point_file = production_5m.xyz      # Node       46911  -4.660227049E+02   4.924117814E+01  -2.594598922E+02
    unit_weight = '0 0 0'
    fluid_phase = 0
    use_mobility = true
    variable = frac_P
...
[Postprocessors]
  ...
  [TK_out]
    type = PointValue
    variable = frac_T
    point = '-4.660227049E+02   4.924117814E+01  -2.594598922E+02'
  []
  [P_out]
    type = PointValue
    variable = frac_P
