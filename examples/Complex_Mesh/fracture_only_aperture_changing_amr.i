...
[Mesh]
  ...
  #   input = cluster34
  #   # bottom_left = '-299 -130 -500'
  #   # top_right = '-301 130 -150'
  #   bottom_left = '-1000 -1000 -1000'
  #   top_right = '1000 1000 1000'
  #   new_boundary = injection_node
  # []
  [injection_node]
    type = BoundingBoxNodeSetGenerator
    input = cluster34
    bottom_left = '-299.452184 0.967337 -193.441202'
    top_right = '-300.352184 1.667337 -194.341202'
    new_boundary = injection_node
  []
[]
...
[DiracKernels]
  [inject_fluid]
    ...
    point = '-299.952184 1.267337 -193.841202'
    variable = frac_P
  []
  [withdraw_fluid]
